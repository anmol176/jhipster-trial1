  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="trial1App.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="trial1App.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="trial1App.country.countryName">Country Name</Translate>
                </th>
                <th>
                  <Translate contentKey="trial1App.country.isoCode">Iso Code</Translate>
                </th>
                <th>
                  <Translate contentKey="trial1App.country.region">Region</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{country.regionRegionName ? <Link to={`region/${country.regionId}`}>{country.regionRegionName}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="trial1App.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
