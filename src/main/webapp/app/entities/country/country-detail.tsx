...
export const CountryDetail = (props: ICountryDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="trial1App.country.detail.title">Country</Translate> [<b>{countryEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{countryEntity.regionRegionName ? countryEntity.regionRegionName : ''}</dd>
        </dl>
