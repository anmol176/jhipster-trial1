  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="trial1App.location.home.createOrEditLabel">
            <Translate contentKey="trial1App.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="locationDetailLabel" for="location-locationDetail">
                  <Translate contentKey="trial1App.location.locationDetail">Location Detail</Translate>
                </Label>
                <AvField
                  id="location-locationDetail"
                  type="text"
                  name="locationDetail"
                  validate={{
                    required: { value: true, errorMessage: translate('entity.validation.required') },
              ...
              <AvGroup>
                ...
                <AvInput id="location-country" type="select" className="form-control" name="countryId" required>
                  {countries
