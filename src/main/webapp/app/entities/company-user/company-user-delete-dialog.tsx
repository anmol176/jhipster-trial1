...
export const CompanyUserDeleteDialog = (props: ICompanyUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trial1App.companyUser.delete.question">
        <Translate contentKey="trial1App.companyUser.delete.question" interpolate={{ id: companyUserEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-companyUser" color="danger" onClick={confirmDelete}>
