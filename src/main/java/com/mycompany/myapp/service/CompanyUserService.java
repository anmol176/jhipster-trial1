...
/**
 * Service Interface for managing {@link com.mycompany.myapp.domain.CompanyUser}.
 */
public interface CompanyUserService {
    ...
    /**
     * Get all the companyUsers with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    Page<CompanyUserDTO> findAllWithEagerRelationships(Pageable pageable);
