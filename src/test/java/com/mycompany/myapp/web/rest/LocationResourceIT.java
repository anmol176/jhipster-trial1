...
public class LocationResourceIT {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLocationDetail()).isEqualTo(DEFAULT_LOCATION_DETAIL);
    }
    ...
    @Test
    @Transactional
    public void checkLocationDetailIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
        location.setLocationDetail(null);
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].locationDetail").value(hasItem(DEFAULT_LOCATION_DETAIL)));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.locationDetail").value(DEFAULT_LOCATION_DETAIL));
    }
    @Test
    @Transactional
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getLocationDetail()).isEqualTo(UPDATED_LOCATION_DETAIL);
    }
