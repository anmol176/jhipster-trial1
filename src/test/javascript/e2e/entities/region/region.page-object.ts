...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('trial1App.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/trial1App.region.delete.question/);
