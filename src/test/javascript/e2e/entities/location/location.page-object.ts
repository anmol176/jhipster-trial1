...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('trial1App.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/trial1App.location.delete.question/);
